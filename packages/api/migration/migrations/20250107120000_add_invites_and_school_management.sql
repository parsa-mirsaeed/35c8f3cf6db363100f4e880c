-- ========================================
-- STEP 1: Create Test School for existing users
-- ========================================
INSERT INTO schools (id, name)
VALUES ('00000000-0000-0000-0000-000000000001', 'Test School')
ON CONFLICT (id) DO NOTHING;

-- ========================================
-- STEP 2: Add school_id column to users table
-- ========================================
...
CREATE TABLE IF NOT EXISTS invites (
    ...
    class_section_ids UUID[] DEFAULT '{}',
...
-- ========================================
-- STEP 4: Create indexes for invites table
-- ========================================
...
-- ========================================
-- STEP 5: Create bootstrap function
-- ========================================
...
-- ========================================
-- (NEW) STEP 5b: Helper to check bootstrap status
-- ========================================
...
-- ========================================
-- STEP 6: Create invite management function
...
-- ========================================
-- STEP 7: Create claim invite function
-- (Parent branch updates existing student.parent_id)
-- ========================================
